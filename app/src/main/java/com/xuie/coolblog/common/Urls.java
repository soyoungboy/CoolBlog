...
public class Urls {
    ...
    public static final String CSDN_CSDN_LIST = "http://blog.csdn.net/xuie0000?viewmode=list";
    ...
    public static final String BLOG_9TH_LIST = "http://xuie0000.com/archives/";
